...
I'm a Data Science student at Xavier University with a passion for using data to solve real-world problems. I enjoy combining programming, statistics, and data visualization to turn data into meaningful insights and actionable solutions.
...
The project uses Python, SQL, and Streamlit to organize player-level statistics, analyze performance trends, and create interactive tools for communicating insights to the coaching staff.

Tools: Python SQL Streamlit Data Visualization Sports Analytics
